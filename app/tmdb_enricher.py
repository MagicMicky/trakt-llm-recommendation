...
class TMDBEnricher:
    ...
    def get_trending_shows(self, time_window: str = 'week', page: int = 1) -> List[Dict[str, Any]]:
        """
        Get trending TV shows.
        
        Args:
            time_window: Time window for trending shows ('day' or 'week')
            page: Page number
        ...
        try:
            ...
            for show in trending_shows:
                ...
                if processed_show.get('backdrop_path'):
                    processed_show['backdrop_url'] = f"https://image.tmdb.org/t/p/w1280{processed_show['backdrop_path']}"
    ...
    def search_shows(self, query: str, page: int = 1) -> List[Dict[str, Any]]:
        """
        Search for TV shows.
        ...
        try:
            search = tmdb.Search()
            response = search.tv(query=query, page=page)
            ...
            for show in search_results:
                ...
                processed_results.append(processed_show)
